...
export default async function Home() {
  return (
    <>
      {/* Banner section*/}
      <section className="h-full w-full md:pt-48 pt-42 relative flex items-center justify-center flex-col">
        {/* grid */}
        ...
        <p className="text-center">Build your background, in one place</p>
